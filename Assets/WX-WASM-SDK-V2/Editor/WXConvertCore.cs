...
namespace WeChatWASM
{
    public class WXConvertCore
    {
        ...
        /// 导入初心桥接
        /// </summary>
        private static void SettingChxSDKJSLib()
        {
            string[] jsLibs;
            string DS = WXAssetsTextTools.DS;
            if (UnityUtil.GetSDKMode() == UnityUtil.SDKMode.Package)
            {
                jsLibs = new string[]
                {
                    $"Packages{DS}com.qq.weixin.minigame{DS}Runtime{DS}Plugins{DS}ChuXinWeChatSDK.jslib",
                };
            }
            else
            {
                ...
                jsLibs = new string[]
                {
                    $"{jsLibRootDir}ChuXinWeChatSDK.jslib",
                };
            }
