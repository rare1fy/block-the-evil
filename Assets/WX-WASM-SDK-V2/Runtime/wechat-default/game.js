    ...
    if (enable) {
        ...
        Object.assign(managerConfig, {
            ...
            loadingPageConfig: {
                ...
                // 以下配置的样式，尺寸相对设计宽高
                textConfig: {
                    firstStartText: '初次见面可能会慢',
                    downloadingText: ['准备派对物料中'],
                    compilingText: '代码和BUG正在互殴',
                    initText: '准备开造！',
                    completeText: '走你！',
                    textDuration: 1500,
                    // 文字样式
        ...
        GameGlobal.events.on('launchOperaPushMsgToWasm', (callback, args) =>
            GameGlobal.WXWASMSDK.WXLaunchOperaBridgeToC(callback, args)
        );
        ...
        // 仅在PC环境生效
        const isPC = !/Mobile|Android|iPhone|iPad|iOS/i.test(navigator.userAgent);
        if (isPC) {
