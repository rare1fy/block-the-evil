...
/// 选项音效结束
/// </summary>
public class FightChatEventFive : FightChatEventBase
{
    public FightChatEventFive(int npcId, FightchatBase cfg, FightChatData data) : base(npcId, cfg, data)
    {
        IsEnd = true;
    }
    ...
    {
        GameManager.Instance.MusicControl.UnlockById(cfg.Music);
        fightChat.Next(0);
