...
public class OutWolrdChatNine : OutWolrdChatBase
{
    public OutWolrdChatNine(OutWord _outWord, string parameter = "", DialogueData data = null) : base(_outWord, parameter, data)
    {
    }
