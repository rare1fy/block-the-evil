...
/// 竖屏UI适配脚本
/// </summary>
[CustomEditor(typeof(UIPortraitFitCompont))]
public class UIPortraitFitCompontEditor : Editor
{
    private UIPortraitFitCompont _adaptation;

    private GUIStyle _customStyle;

    void OnEnable()
    {
        _adaptation = serializedObject.targetObject as UIPortraitFitCompont;
    ...
    public override void OnInspectorGUI()
    {
        ...
        _adaptation.adaptationType = (EUIAdaptationType)EditorGUILayout.EnumPopup("适配类型",
            _adaptation.adaptationType, _customStyle);
