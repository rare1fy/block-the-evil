using System.Collections.Generic;
    ...
    public class ItemSizeGroup
    {
        ...
        public ItemSizeGroup(int index, float itemDefaultSize, float listOffset)
        {
            mGroupIndex = index;
        ...
        public void Init()
        {
            ...
            mItemStartPosArray[0] = mListOffset;
...
public class ItemPosMgr
{
    ...
    public ItemPosMgr(float itemDefaultSize, float listOffset)
    {
        mItemDefaultSize = itemDefaultSize;
        mListOffset = listOffset;
    }
    ...
    public void SetItemMaxCount(int maxCount)
    {
        ...
        else if (count < needMaxGroupCount)
        {
            ...
            for (int i = 0; i < d; ++i)
            {
                ItemSizeGroup tGroup = new ItemSizeGroup(count + i, mItemDefaultSize, mListOffset);
